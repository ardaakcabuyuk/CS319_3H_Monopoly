...
public class GameScreen {
    ...
    {
        //System.out.println("ApplicationControl/Images/card_deck_"+AssetManager.gameManager.getCurrentPlayer().getColorName()+"_turn.png");
        Image img = new Image("UserInterface/Images/card_deck_" +AssetManager.gameManager.getCurrentPlayer().getColorName()+"_turn.png");
    ...
    public void movePawnImage(ImageView pawnImage, int index, Pawn curPawn) throws IOException {
        ...
        if ( nextLandable.getType() == LandableType.FUNCTIONAL_PLACE || nextLandable.getType() == LandableType.ATALARS_ROOM ) {
            ...
            imageNamePopup = "UserInterface/Images/buildings_all_png/" + nameOfLand + ".png";
        ...
        else if ( nextLandable.getType() == LandableType.CAFE )
        {
            ...
            imageNamePopup = "UserInterface/Images/cafes_png/" + nameOfLand + ".png";
            executeCafePopup();
        }
        //for card popups
    ...
    public void animatePawnImageMovement(ImageView pawnImage, int index, Pawn curPawn) throws IOException{
        ...
        if ( nextLandable.getType() != LandableType.FUNCTIONAL_PLACE )
        {
            ...
            if ( nextLandable.getType() == LandableType.LAND )
            {
                ...
                imageNamePopup = "ApplicationControl/Images/buildings_all_png/" + nameOfLand + ".png";
            ...
            else if ( nextLandable.getType() == LandableType.CAFE )
            {
                ...
                imageNamePopup = "ApplicationControl/Images/cafes_png/" + nameOfLand + ".png";
