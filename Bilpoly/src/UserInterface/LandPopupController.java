...
public class LandPopupController {
    ...
    public void initialize() {
        ...
        else if (curLand.isBought() && curPlayer.isBoughtSet(curLand.getCOLOR()))
        {
                ...
                String imageName1 = "UserInterface/Images/buildings_all_png/" + lands[0].getName()+ ".png";
                ...
                if (j > 1) {
                    ...
                    String imageName3 = "UserInterface/Images/buildings_all_png/" + lands[1].getName()+ ".png";
